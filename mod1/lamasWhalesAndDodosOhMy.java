...
public class lamasWhalesAndDodosOhMy {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("there has also been a large increase in the llamas popoulation do to the infestation of dodo grass!");
        llamas += 81;
